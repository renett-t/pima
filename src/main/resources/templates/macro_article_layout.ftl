    ...
    <div class="article-wrapper">
        ...
        <div class="article-heading-elements">
            ...
            <div class="article-heading-author"><@spring.message 'page.article.published_by'/>${article.author.userName}
                , ${article.publishedAt.toLocaleString()}</div>
        ...
        <div class="article-footer-wrapper">
            ...
            <div class="article-comments-count">${article.commentAmount}
                <img class="icon-img comment-icon" src="<@spring.url'/resources/icons/comment.png'/>"
            ...
            <div class="article-likes-count">
                ...
                <#if liked?? && liked == true>
                    <img class="icon-img like-icon liked" id="like-icon-request"
                         src="<@spring.url'/resources/icons/like-active.png'/>" alt="likes count icon">
                <#else>
                    <img class="icon-img like-icon" id="like-icon-request"
                         src="<@spring.url'/resources/icons/like.png'/>" alt="likes count icon">
                </#if>
