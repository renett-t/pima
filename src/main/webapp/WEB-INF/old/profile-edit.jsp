...
<t:mainLayout title="Профиль - Редактирование"><%--@elvariable id="user" type="ru.renett.models.User"--%>
    <form method="POST" class="account-form">
        <div class="row row-cols-2">
            ...
            <div class="col">
                ...
                <input name="login" class="input-field form-control" id="loginInput" type="text" value="${user.username}">
